...
export default function LoreProposalReview({
  ...
  // Diagnostic (kept): fetch the full extraction round-trip (model, prompt, raw responses, parsed)
  // for one record and show it — so a failed extraction on a local model is diagnosable.
