...
export const updateProjectSettings = (name: string, body: { llm_provider?: string, model?: string, utility_model?: string, fallback_chain?: string[] }) => api.put(`/projects/${name}/settings`, body).then(r => r.data)
